...
%-----------------------------------------------------------------------
I hereby declare in accordance with  APO \S  9, subsection 12, that I have written the preceding \ifthesis\degree's thesis\fi \ifseminar report\fi independently and that I have not used any other sources or aids than those indicated above.
\\
Furthermore, I declare that the digital version of the printed copy of the \ifthesis\degree's thesis\fi \ifseminar report\fi  corresponds without any exception to the content and wording of the printed version of the \ifthesis\degree's thesis\fi \ifseminar report\fi. Furthermore, I declare  that I have taken note of the regulation that this digital version of the \ifthesis\degree's thesis\fi \ifseminar report\fi can be the subject of an anonymous plagiarism checking supported by software.
\\[2cm]
%-----------------------------------------------------------------------

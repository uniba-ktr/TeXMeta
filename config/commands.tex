...
%-----------------------------------------------------------------------
Ich erkläre hiermit gemäß  APO \S  9, Absatz 12, dass ich die vorstehende \ifthesis\degree arbeit\fi \ifseminar Hausarbeit~\fi selbständig verfasst habe und ich keine anderen als die angegebenen Quellen und Hilfsmittel benutzt habe.
\\
Des Weiteren erkläre ich, dass die digitale Fassung der gedruckten Ausfertigung der \ifthesis\degree arbeit\fi \ifseminar Hausarbeit~\fi ausnahmslos in Inhalt und Wortlaut entspricht und zur Kenntnis genommen wurde, dass diese digitale Fassung einer durch Software unterstützten, anonymisierten Prüfung auf Plagiate unterzogen werden kann.
%-----------------------------------------------------------------------
\\
%-----------------------------------------------------------------------
\section*{Declaration on the Compliance With Regulations of ``Allgemeine Prüfungsordnung'' (APO) WIAI}
%-----------------------------------------------------------------------
I hereby declare in accordance with  APO \S  9, subsection 12, that I have written the preceding \ifthesis\lowercase{\degree}'s thesis\fi \ifseminar report~\fi independently and that I have not used any other sources or aids than those indicated above.
\\
Furthermore, I declare that the digital version of the printed copy of the \ifthesis\lowercase{\degree}'s thesis\fi \ifseminar report~\fi  corresponds without any exception to the content and wording of the printed version of the \ifthesis\lowercase{\degree}'s thesis\fi \ifseminar report~\fi. Furthermore, I declare  that I have taken note of the regulation that this digital version of the \ifthesis\lowercase{\degree}'s thesis\fi \ifseminar report~\fi can be the subject of an anonymous plagiarism checking supported by software.
\\[2cm]
%-----------------------------------------------------------------------

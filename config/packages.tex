...
\usepackage{tikz}
\usepackage{pgfplots}
\usetikzlibrary{calc,arrows,arrows.meta,fit,positioning,trees,intersections,backgrounds,shadows,decorations,decorations.text,decorations.markings,decorations.shapes,decorations.pathmorphing,shapes,shapes.arrows,patterns,patterns.meta,fadings,matrix}
...
\ifthesis
\usepackage[automark]{scrlayer-scrpage}            % Kopf und Fusszeilen-Layout
\else
\usepackage{fancyhdr}
\fi

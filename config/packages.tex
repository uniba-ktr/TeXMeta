...
\usepackage{tikz}
\usepackage{pgfplots}
\usetikzlibrary{calc,arrows,fit,positioning,trees,snakes,backgrounds,shadows,decorations,decorations.text,decorations.markings,decorations.shapes,shapes,patterns,fadings}

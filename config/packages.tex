...
\usepackage{tikz}
\usepackage{pgfplots}
\usetikzlibrary{calc,arrows,fit,positioning,trees,intersections,backgrounds,shadows,decorations,decorations.text,decorations.markings,decorations.shapes,decorations.pathmorphing,shapes,patterns,fadings,matrix,snakes}

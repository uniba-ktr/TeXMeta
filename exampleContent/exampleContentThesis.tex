...
Stichwörter\index{Stichwort} können mit \lstinline|\index{Stichwort}| angelegt werden. Weitere Schlagwörter\index{Stichwort!Schlagwort} hängt man mit \lstinline|\index{Stichwort!Schlagwort}| an \footnote{\url{http://www2.informatik.hu-berlin.de/~piefel/LaTeX-PS/V03-index.pdf}}.
